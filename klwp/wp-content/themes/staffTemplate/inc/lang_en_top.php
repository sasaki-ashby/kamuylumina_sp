...
$top_copy = [
	...
	'top6' => [ 'Of particular note is the special item, a rhythm stick. When getting it into your hands,mysterious things may happen.' ],

	'top7' => [
		'Entrust yourself to the 50-minute magnificent journey, in a fantastic world woven by digital art of light and sound fusing with nature, and enjoy the exciting moments.',
		'KAMUY LUMINA - AN ENCHANTED NIGHT WALK AT LAKE AKAN is a special journey that spreads enchantment beyond words. You should visit and will be touched by this experience.'
	],
	'top8' => [ 'This time, four locals experienced the adventure together.',
		'Enjoy the Akan Area',
		'We deliver the latest information about Akan, such as the hot springs in Lake Akan and Ainu culture.'
	],
